...
public class SetMessageRuleCommand extends AbstractPlayerCommand {
    public SetMessageRuleCommand(){
        super("setmessagerule","A command to set isMessageAppear in Loot_chest_config resource of the world.");
    }
